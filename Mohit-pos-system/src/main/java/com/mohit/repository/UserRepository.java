...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	List<User> findByStoreAndRoleIn(com.mohit.modal.Store store, List<UserRole> roles);
	List<User> findByBranchAndRoleIn(com.mohit.modal.Branch branch, List<UserRole> roles);
